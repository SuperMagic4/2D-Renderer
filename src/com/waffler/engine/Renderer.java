...
import com.waffler.engine.gfx.Font;
import com.waffler.engine.gfx.Image;
import com.waffler.engine.gfx.ImageRequest;
import com.waffler.engine.gfx.ImageTile;
import com.waffler.engine.gfx.Light;
import com.waffler.engine.gfx.LightRequest;
...
public class Renderer
{
	...
	private int ambientColor = 0xff2d2c2c;
	...
	public Renderer(GameContainer gc)
	{
		pW = gc.getWidth();
		pH = gc.getHeight();
		p = ((DataBufferInt)gc.getWindow().getBi().getRaster().getDataBuffer()).getData();
		zb = new int[p.length];
		lm = new int[p.length];
		lb = new int[p.length];
	}
	...
	public void process() {
		...
		Collections.sort(imageRequest, new Comparator<ImageRequest>() {
			...
			@Override
			public int compare(ImageRequest a1, ImageRequest a2) {
				if(a1.zDepth < a2.zDepth)
					return -1;
				if(a1.zDepth > a2.zDepth)
					return 1;
				return 0;
	...
	public void drawImage(Image image, int offX, int offY) {
		...
		//Unrender image outside of window
		if(offX < -image.getW()) {
			return;
		}
